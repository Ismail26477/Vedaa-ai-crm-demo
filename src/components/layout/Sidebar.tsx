...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { icon: ListTodo, label: "Follow-ups", path: "/follow-ups" },
    { icon: BarChart3, label: "Reports", path: "/reports" },
    ...(isAdmin ? [{ icon: Phone, label: "Callers", path: "/callers" }] : []),
    ...(isAdmin ? [{ icon: Briefcase, label: "Brokers", path: "/brokers" }] : []),
        ...
        >
          {!collapsed && (
            <div className="flex items-center gap-2">
              <img src="/vedaa-ai-logo1.png" alt="GrabDeal Logo" className="w-52 h-56 object-contain" />
              <span className="text-xl font-bold text-white font-display"></span>
            </div>
          )}
          {collapsed && <img src="/vedaa-ai-logo2.png" alt="GrabDeal Logo" className="w-70 h-74 object-contain" />}
        </div>
